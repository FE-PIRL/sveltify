...
import { Card, CardTitle, CardText, CardSubtitle, CardActions, Button } from 'sveltify/src';
...
<Playground controls="{controls}" variants="{variants}" bind:values>
  <div class="pa-4 mt-6 mb-6">
    <Card
      ...
      <CardText>
        Lorem ipsum dolor sit amet consectetur adipisicing elit. Sed exercitationem repellat
        voluptatum nostrum! Reprehenderit temporibus modi perspiciatis perferendis totam placeat
        vitae omnis ipsa quibusdam animi?
      </CardText>
      <CardActions>
