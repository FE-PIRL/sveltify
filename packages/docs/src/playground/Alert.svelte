...
import { Alert, Icon } from 'sveltify/src';
...
<Playground variants="{variants}" controls="{controls}" bind:values>
  <Alert
    ...
    Lorem, ipsum dolor sit amet consectetur adipisicing elit. Omnis itaque excepturi suscipit possimus
    blanditiis, illum libero sequi a deleniti sapiente.
  </Alert>
</Playground>
