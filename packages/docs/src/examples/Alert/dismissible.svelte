<script>
import { Alert, Icon, Button } from 'sveltify/src';
...
{#if alert}
  ...
  <Alert class="primary-color" dismissible bind:visible="{alert}" on:dismiss="{onDismiss}">
    ...
    Lorem ipsum, dolor sit amet consectetur adipisicing elit. Dolorem molestiae voluptates et quae rem
    autem quasi officia odit suscipit dolor.
  </Alert>
{:else}
