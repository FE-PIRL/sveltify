...
If you want a fast and basic setup, without custom SCSS/SASS, then only installing `sveltify` should be fine:
...
```shell
$ npm i -D sveltify svelte-preprocess sass postcss
```
